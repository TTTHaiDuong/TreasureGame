...
namespace GameItems
{
    ...
    {
        private Vector2 RatioImageToCountText;
        ...
        private void Awake()
        {
            ...
            RatioImageToCountText = new Vector2(RectImage.sizeDelta.x / RectCount.sizeDelta.x, RectImage.sizeDelta.y / RectCount.sizeDelta.y);
        }
        ...
        public void SetSize(Vector2 size)
        {
            ...
            RectCount.sizeDelta = new Vector2(size.x / RatioImageToCountText.x, size.y / RatioImageToCountText.y);
        }
    ...
    public abstract class GameItem : ICloneable
    {
        ...
        public abstract bool Compare(GameItem item);
    ...
    public class Bomb : GameItem
    {
        ...
        public override bool Compare(GameItem item) => item is Bomb bomb && bomb.Count == Count && bomb.Explode == Explode;
    ...
    public class Glasses : GameItem
    {
        ...
        public override bool Compare(GameItem item) => item is Glasses glasses && glasses.Count == Count;
    }
    ...
    public class SuperShovel : GameItem
    {
        ...
        public override bool Compare(GameItem item) => item is SuperShovel shovel && shovel.Count == Count;
    }
    ...
    public class Gold : GameItem
    {
        ...
        public override bool Compare(GameItem item) => item is Gold gold && gold.Count == Count;
    }
    ...
    public class Score : GameItem
    {
        ...
        {
            if (item is Score score && score.Count == Count) return true;
            else return false;
        }
    }
